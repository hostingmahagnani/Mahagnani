...
export function CourseGrid({ limit = 4 }) {
  console.log("[v0] CourseGrid: Fetching courses")
  const courses = getAllCourses().slice(0, limit)
  console.log("[v0] CourseGrid: Courses found:", courses.length)

  return (
    <section className="py-20 relative overflow-hidden">
      {/* Animated background */}
      <div className="absolute top-1/4 left-0 w-64 h-64 bg-gradient-to-r from-primary/5 to-transparent blur-3xl rounded-full animate-pulse-slow"></div>
      <div className="absolute bottom-1/4 right-0 w-64 h-64 bg-gradient-to-l from-purple-500/5 to-transparent blur-3xl rounded-full animate-pulse-slower"></div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
          <div className="space-y-4">
            ...
            <h3 className="text-3xl md:text-4xl font-bold animate-fade-in-up animation-delay-200">
